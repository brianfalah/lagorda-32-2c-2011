...
int log_info(t_log *log, const char *thread_name, const char* format, ... ) {
	...
	return log_vwrite(log, thread_name, INFOLOG, format, args_list);
}
...
int log_error(t_log *log, const char *thread_name, const char* format, ... ) {
	va_list args_list;
	va_start(args_list, format);
	return log_vwrite(log, thread_name, ERRORLOG, format, args_list);
}
...
int log_write_without_extra_info(t_log *log, const char* format, ...) {
